      ...
      try {
        ...
        try {
          ...
          if (packageJsonExists) {
            // Files are already mounted, just reconnect to existing serer
        ...
        const installedExistCode = await installProcess.exit;

        if (installedExistCode !== 0) {
          throw new Error(
            `Failed to install dependencies. Exist code: ${installedExistCode}`
          );
        }
      ...
      <div className="h-full flex items-center justify-center">
        <div className="text-center space-y-4 max-w-md p-6 rounded-lg bg-gray-50 dark:bg-gray-900">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Setting up your development environment. This may take a few
            moments.
          </p>
        </div>
      </div>
